...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($slide->slider_title) ? 'Edit: '. $slide->slider_title : 'Add Slide' }}</h2>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($slide->slider_title) ? 'Edit Slide' : 'Add Slide' }}</button>
