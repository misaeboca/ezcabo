            ...
            @foreach($alltestimonials as $i => $testimonial)
                ...
                <div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-menu-right" role="menu"> 
									<li><a href="{{ url('admin/testimonials/addtestimonial/'.Crypt::encryptString($testimonial->id)) }}"><i class="md md-edit"></i> Edit Editor</a></li>
									<li><a href="{{ url('admin/testimonials/delete/'.Crypt::encryptString($testimonial->id)) }}"><i class="md md-delete"></i> Delete</a></li>
								</ul>
							</div> 
