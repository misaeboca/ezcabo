            ...
            @foreach($alltypes as $i => $type)
                ...
                <div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-menu-right" role="menu"> 
									...
									<li><a href="{{ url('admin/types/delete/'.$type->id) }}" onclick="return confirm('Are you sure? You will not be able to recover this item and related properties data.')"><i class="md md-delete"></i> Delete</a></li>
								</ul>
							</div> 
