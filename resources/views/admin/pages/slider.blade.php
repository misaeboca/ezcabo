            ...
            @foreach($allslider as $i => $slide)
                ...
                <div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-menu-right" role="menu"> 
									<li><a href="{{ url('admin/slider/addslide/'.Crypt::encryptString($slide->id)) }}"><i class="md md-edit"></i> Edit Editor</a></li>
									<li><a href="{{ url('admin/slider/delete/'.Crypt::encryptString($slide->id)) }}"><i class="md md-delete"></i> Delete</a></li>
								</ul>
							</div> 
