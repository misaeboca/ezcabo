...
<div class="row">
        ...
        <div class="panel panel-grey panel-shadow">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
                        <div class="width-100">
                            <h5 class="margin-none" id="graphWeek-y">Pending</h5>
    ...
    <a href="{{ URL::to('admin/users') }}">
    	<div class="col-sm-6 col-md-3">
        <div class="panel panel-pink panel-shadow" style=" background: #bd0728!important;
  color: #fff;">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
    ...
    <a href="{{ URL::to('admin/testimonials') }}">
    	<div class="col-sm-6 col-md-3">
        <div class="panel panel-shadow" style=" background: #0db5b5!important;
  color: #fff;">
            <div class="media">
                <div class="media-left">
                    <div class="panel-body">
