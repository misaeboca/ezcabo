...
<table border="0" cellpadding="0" cellspacing="0" width="60%" style="margin:0 auto;border:1px solid rgba(0, 0, 0, 0.2);padding:20px;">
 ...
 <tr>
  ...
  Thanks for creating an account with <b>{{getcong('site_name')}}</b>. Please follow the link below to verify your email address
  </td>
 </tr>
 <tr>
  <td style="text-align:center; margin:10px auto;float:left;width:100%;line-height:48px;">
   <a href="{{ URL::to('auth/confirm/' . $confirmation_code) }}" style="font-size: 15px;margin-bottom:10px;text-align: center;background: #007ee6;color: #fff;border-radius: 6px;text-decoration:none;padding:15px 30px;">Verify Account</a>
  </td>
 </tr>
 <tr>
